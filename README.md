...
The first complete vertical slice is **Chapter 1 / Binary Search**. It should include:

- intuitive search analogy
- interactive number-guessing experience
- simple-search vs. binary-search comparison
- halving visualization
- logarithm intuition
- synchronized `low / mid / high` state
- runnable Python 3 implementation
- embedded exercises
- from-memory rebuild
- complexity explanation
- a small LeetCode transfer ladder
- review scheduling

The MVP is successful when a learner can return days later, implement binary search from scratch, explain why it works, and recognize the pattern in an unlabeled problem.

## Status

Documentation-first. Implementation should follow the contracts and guardrails in `/docs` and `AGENTS.md`.
