...
test("export only includes AgoCode-prefixed browser state", () => {
...
test("serialized data round-trips and ignores foreign keys", () => {
...
test("replace import clears existing AgoCode keys without touching unrelated storage", () => {
  const target = storage({ "agocode.progress.old": "old", unrelated: "keep" });
