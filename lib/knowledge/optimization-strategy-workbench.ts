    ...
    strategies: [
      {
        ...
        guarantee: "Returns an optimal cover when exhaustive enumeration is allowed to finish.",
      ...
      },
      {
        ...
        guarantee: "Provides a logarithmic approximation bound for standard set cover.",
      ...
      },
      {
        ...
        guarantee: "Provides no general optimality guarantee in this simple local-search form.",
        practicalThrough: "large",
    ...
    strategies: [
      {
        ...
        class: "exact",
        complexity: "O(2^V · E)",
        guarantee: "Returns a minimum vertex cover when exhaustive search is completed.",
        practicalThrough: "tiny",
        requires: ["Tiny graph"],
      ...
      },
      {
        ...
        guarantee: "Returns an optimal cover when the exact search completes.",
        practicalThrough: "moderate",
      ...
      },
      {
        ...
        class: "approximation",
        complexity: "O(V + E)",
        guarantee: "Returns a cover of size at most 2× optimum for unweighted vertex cover.",
        practicalThrough: "large",
      ...
      },
      {
        ...
        guarantee: "Provides no fixed approximation factor for this simple highest-degree rule.",
        practicalThrough: "large",
    ...
    strategies: [
      {
        ...
        class: "exact",
        complexity: "O(n² · 2^n)",
        guarantee: "Returns the globally minimum tour when the subset dynamic program completes.",
        practicalThrough: "tiny",
      ...
      },
      {
        ...
        guarantee: "Can certify the globally optimal tour when the solver completes with proof.",
        practicalThrough: "moderate",
      ...
      },
      {
        ...
        guarantee: "Returns a tour costing at most 2× optimum for metric TSP.",
        practicalThrough: "large",
      ...
      },
      {
        ...
        guarantee: "Provides no constant-factor guarantee for arbitrary metric instances from this rule alone.",
        practicalThrough: "large",
    ...
    strategies: [
      {
        ...
        class: "exact",
        complexity: "O(nC)",
        guarantee: "Returns the globally optimal 0/1 selection for the modeled integer capacity.",
        practicalThrough: "moderate",
      ...
      },
      {
        ...
        guarantee: "Returns the globally optimal feasible subset when the exact search completes.",
        practicalThrough: "moderate",
      ...
      },
      {
        ...
        guarantee: "Provides tunable approximation quality under the standard scaling-scheme assumptions.",
        practicalThrough: "large",
      ...
      },
      {
        ...
        guarantee: "Does not guarantee an exact 0/1 optimum; density-only choices can be arbitrarily misleading without safeguards.",
        practicalThrough: "large",
